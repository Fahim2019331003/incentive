...
const EditProfile = ({ user, isEditOpen, setEditOpen ,changed,setChanged ,viewer}) => {
      ...
      {loading ? (
        ...
        <div>
          <div className="flex items-center m-10 max-w-6xl mx-auto">
            ...
            { (viewer?.role==="ADMIN" || user.email===viewer.email ) && (<div className="flex-1 flex justify-end items-center">
              <Button
