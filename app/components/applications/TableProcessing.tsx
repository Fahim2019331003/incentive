...
import getTableProcessingData from '@/app/actions/getTableProcessingData';
...
const TableProcessing = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response: any = await getTableProcessingData();
  ...
  const onCloseHandlerA = async () => {
    ...
    if (
      ...
      const response = await updateApplicationStatus(valueId,'processing',selectedOption,"","");
      ...
      const newData: any = await getTableProcessingData();
      setDatas(newData);
                ...
                <>
                  ...
                  <ModalBody>
                    <p>
                      ...
                      application(s) to {selectedOptionName} for review?
                    </p>
                  </ModalBody>
                  <ModalFooter>
                ...
                <>
                  ...
                  <ModalBody>
                    <p>
                      ...
                      {Array.from(selectedKeys).length} application(s) for
                      evaluation.
                    </p>
                    <CustomRadioGroup selectedOption={selectedOption} setSelectedOption={setSelectedOption}/>
                  </ModalBody>
                  <ModalFooter>
