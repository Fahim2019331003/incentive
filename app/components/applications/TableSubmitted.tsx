...
import getTableSubmittedData from '@/app/actions/getTableSubmittedData';
...
const TableSubmitted = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response: any = await getTableSubmittedData();
  ...
  const onCloseHandler = async () => {
    ...
    if (
      ...
      const newData: any = await getTableSubmittedData();
      setDatas(newData);
