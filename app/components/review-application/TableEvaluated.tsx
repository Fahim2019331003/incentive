...
import getTableEvaluatedData from '@/app/actions/getTableEvaluatedData';
...
const TableEvaluated = ({user}) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response: any = await getTableEvaluatedData(user.id);
