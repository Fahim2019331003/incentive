...
import getUserIncentiveTableData from '@/app/actions/getUserIncentiveTableData';
...
const UserIncentiveTable = ({userEmail}) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response: any = await getUserIncentiveTableData(userEmail);
...
export default UserIncentiveTable;
